...
ggplot(data = subset(bxpl_data_ampl2, Test_Type == "Audiogram_L"), 
  ...
  theme(legend.position="none",
        ...
        strip.text = element_text(color = 'black'),
        strip.background = element_rect(fill = 'white') ) + 
  ylab("dB HL")  + xlab("Frequency Left Audiogram") 
dev.off()
...
ggplot(data = subset(bxpl_data_ampl2, Test_Type == "Audiogram_R"), 
  ...
  theme(legend.position="none",
        ...
        strip.text = element_text(color = 'black'),
        strip.background = element_rect(fill = 'white') ) + 
  ylab("dB HL")  + xlab("Frequency Right Audiogram") 
dev.off()
...
ggplot(data = subset(bxpl_data_ampl2, Test_Type == "Speech_Tests"), 
  ...
  theme(legend.position="none",
        ...
        strip.text = element_text(color = 'black'),
        strip.background = element_rect(fill = 'white') ) + 
  ylab("dB SPL/SNR")  + xlab("Speech Tests") + 
  scale_x_discrete(labels = c(expression(SRT[Q]), expression(SRT[N]))) 
dev.off()
